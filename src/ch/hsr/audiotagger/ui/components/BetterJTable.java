...
/**
 * @author explodingpixels.wordpress.com
 * @see http://explodingpixels.wordpress.com/2009/05/18/creating-a-better-jtable/
 */
public class BetterJTable extends JTable {
    ...
    private static final long serialVersionUID = 4064040727668547817L;
    ...
    private JTableHeader createTableHeader() {
        return new JTableHeader(getColumnModel()) {
			...
			private static final long serialVersionUID = 7340281696367327568L;
    ...
    private static class StripedViewport extends JViewport {
		...
		private static final long serialVersionUID = -6587517513888968876L;
    ...
    private static JComponent createCornerComponent(final JTable table) {
        return new JComponent() {
			...
			private static final long serialVersionUID = 3459144451073564499L;
